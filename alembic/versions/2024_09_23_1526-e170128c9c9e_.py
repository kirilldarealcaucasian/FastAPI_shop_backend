...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('id', name=op.f('uq_payment_details_id'))
    )
    ...
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['payment_id'], ['payment_details.id'], name=op.f('fk_orders_payment_id_payment_details'), ondelete='RESTRICT'),
