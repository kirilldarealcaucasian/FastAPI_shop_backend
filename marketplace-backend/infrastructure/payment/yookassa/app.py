...
class PaymentProviderInterface(Protocol):
    ...
    def create_payment(self, payment_data: CreatePaymentRequest) -> CreatePaymentResponse: ...
    ...
    async def make_refund(self, payment_id: UUID, amount: float, description: str): ...
...
class YooKassaPaymentProvider:
    ...
    def create_payment(self, payment_data: CreatePaymentRequest) -> CreatePaymentResponse:
        ...
        try:
            ...
            logger.error("Failed to create payment object", exc_info=True, extra=extra)
        ...
        return CreatePaymentResponse(confirmation_url=confirmation_url, payment_id=payment_id)
    ...
    async def check_payment_status(
        ...
        extra = {"payment_id": payment_id, "shopping_session_id": shopping_session_id}
        ...
        if payment_status == "succeeded":
            ...
            try:
                ...
                # make refund
                self.make_refund(
                    payment_id=payment_id, amount=amount, description=str(e)
                )
    ...
    def make_refund(self, payment_id: UUID, amount: float, description: str):
        try:
            Refund.create(
                {
                    "payment_id": payment_id,
